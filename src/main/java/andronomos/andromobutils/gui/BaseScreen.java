package andronomos.andromobutils.gui;

import andronomos.andromobutils.AndroMobUtils;
import andronomos.andromobutils.util.ChatUtil;
...
public abstract class BaseScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
	public static final ResourceLocation INVENTORY = new ResourceLocation(AndroMobUtils.MOD_ID, "textures/gui/inventory.png");
	public static final ResourceLocation INVENTORY_PLAIN = new ResourceLocation(AndroMobUtils.MOD_ID, "textures/gui/inventory_plain.png");
	public static final ResourceLocation INVENTORY_LARGE = new ResourceLocation(AndroMobUtils.MOD_ID, "textures/gui/inventory_large.png");
	public static final ResourceLocation SLOT = new ResourceLocation(AndroMobUtils.MOD_ID, "textures/gui/slot.png");
	public static final ResourceLocation SLOT_ENCHANTED_BOOK = new ResourceLocation(AndroMobUtils.MOD_ID, "textures/gui/slot_enchanted_book.png");
