...
import andronomos.andromobutils.block.MobClonerBlock;
import andronomos.andromobutils.block.LootAttractorBlock;
import andronomos.andromobutils.block.LootIncineratorBlock;
import andronomos.andromobutils.block.pad.MobKillingPadBlock;
import andronomos.andromobutils.block.pad.emiiter.EmitterPadBlock;
import andronomos.andromobutils.block.pad.emiiter.effect.PadEffect;
import andronomos.andromobutils.block.pad.emiiter.effect.PadEffects;
...
public class ModBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, AndroMobUtils.MOD_ID);
