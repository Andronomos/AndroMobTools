...
public class BlockMinerScreen extends MachineScreen<BlockMinerContainer> {
	public static final ResourceLocation TEXTURE = new ResourceLocation(AndroTech.MOD_ID, "textures/gui/machine/block_miner.png");
	private PowerButton powerButton;
	private BlockMinerContainer container;

	 public BlockMinerScreen(BlockMinerContainer container, Inventory inventory, Component component) {
