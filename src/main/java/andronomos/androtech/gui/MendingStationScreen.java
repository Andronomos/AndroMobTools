...
public class MendingStationScreen extends BaseScreen<MendingStationContainer> {
	public MendingStationScreen(MendingStationContainer container, Inventory inventory, Component component) {
