...
public abstract class ToggleableDevice extends AbstractDevice {
	public final static String TAG_ACTIVATED = "activated";

	public ToggleableDevice(Item.Properties properties) {
		super(properties, false);
	}

	public ToggleableDevice(Item.Properties properties, boolean takeDamage) {
