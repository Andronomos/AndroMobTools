...
public class FluidRegistry {
	...
	public static final RegistryObject<FlowingFluid> LIQUID_XP = FLUIDS.register("liquid_xp_fluid",
	...
	public static final ForgeFlowingFluid.Properties LIQUID_XP_FLUID_PROPERTIES = new ForgeFlowingFluid.Properties(
			FluidTypeRegistry.LIQUID_XP_FLUID_TYPE, LIQUID_XP, LIQUID_XP_FLOWING)
