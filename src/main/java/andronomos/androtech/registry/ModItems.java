...
import andronomos.androtech.item.activatableItem.AttractorModuleItem;
import andronomos.androtech.item.activatableItem.NaniteModuleItem;
...
import static andronomos.androtech.item.activatableItem.AttractorModuleItem.ATTRACTOR_UNIT_DURABILITY;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> ATTRACTOR_MODULE = ITEMS.register("attractor_module", () -> new AttractorModuleItem(GetBaseProperties().durability(ATTRACTOR_UNIT_DURABILITY)));
    ...
    public static final RegistryObject<Item> MOB_TRANSPORTER_MODULE = ITEMS.register("mob_transporter_module", () -> new MobTransporterModuleItem(GetBaseProperties()));
    ...
    public static final RegistryObject<Item> NANITE_MODULE = ITEMS.register("nanite_module", () -> new NaniteModuleItem(GetBaseProperties().durability(ATTRACTOR_UNIT_DURABILITY)));
