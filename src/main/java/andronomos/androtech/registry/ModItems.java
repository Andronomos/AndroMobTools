...
public class ModItems {
    ...
    public static final RegistryObject<Item> WATER_BREATHING_MODULE = ITEMS.register("water_breathing_module", () -> new EffectEmitterItem(EMITTER_PROPERTIES, MobEffects.WATER_BREATHING, Const.EffectAmplifier.V));
