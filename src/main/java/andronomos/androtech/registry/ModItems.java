...
public class ModItems {
    ...
    public static final RegistryObject<Item> ITEM_ATTRACTOR_MODULE = ITEMS.register("item_attractor_module", () -> new ItemAttractorModule(GetBaseProperties().durability(ATTRACTOR_UNIT_DURABILITY)));
    ...
    public static final RegistryObject<Item> MOB_TRANSPORT_MODULE = ITEMS.register("mob_transport_module", () -> new MobTransportModule(GetBaseProperties()));
    ...
    public static final RegistryObject<Item> NANITE_MODULE = ITEMS.register("nanite_module", () -> new NaniteModule(GetBaseProperties().durability(ATTRACTOR_UNIT_DURABILITY)));
    ...
    public static final RegistryObject<Item> NANITE_ENHANCED_PICKAXE = ITEMS.register("nanite_enhanced_pickaxe", () -> new NaniteEnhancedPickAxe(Tiers.NETHERITE, 1, -2.8F, GetBaseProperties()));
    public static final RegistryObject<Item> NANITE_ENHANCED_AXE = ITEMS.register("nanite_enhanced_axe", () -> new NaniteEnhancedAxe(Tiers.NETHERITE, 5.0F, -3.0F, GetBaseProperties()));
    public static final RegistryObject<Item> NANITE_ENHANCED_SHOVEL = ITEMS.register("nanite_enhanced_shovel", () -> new NaniteEnhancedShovel(Tiers.NETHERITE, 5.0F, -3.0F, GetBaseProperties()));
