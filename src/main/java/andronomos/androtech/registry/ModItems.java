...
import andronomos.androtech.item.device.AbstractDevice;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> PORTABLE_ITEM_MENDER = ITEMS.register("portable_item_mender", () -> new PortableItemMender(GetBaseProperties().durability(AbstractDevice.DURABILITY), true));
