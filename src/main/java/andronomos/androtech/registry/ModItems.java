...
public class ModItems {
    ...
    public static final RegistryObject<Item> SWIFTNESS_EMITTER = ITEMS.register("swiftness_emitter", () -> new EffectEmitter(EMITTER_PROPERTIES, MobEffects.MOVEMENT_SPEED, Const.EffectAmplifier.V, true, true));
    public static final RegistryObject<Item> FIRE_RESISTANCE_EMITTER = ITEMS.register("fire_resistance_emitter", () -> new EffectEmitter(EMITTER_PROPERTIES, MobEffects.FIRE_RESISTANCE, Const.EffectAmplifier.I, true, true));
    public static final RegistryObject<Item> REGENERATION_EMITTER = ITEMS.register("regeneration_emitter", () -> new EffectEmitter(EMITTER_PROPERTIES, MobEffects.REGENERATION, Const.EffectAmplifier.V, true, true));
    public static final RegistryObject<Item> NIGHT_VISION_EMITTER = ITEMS.register("night_vision_emitter", () -> new EffectEmitter(EMITTER_PROPERTIES, MobEffects.NIGHT_VISION, Const.EffectAmplifier.V, true, true));
    public static final RegistryObject<Item> WATER_BREATHING_EMITTER = ITEMS.register("water_breathing_emitter", () -> new EffectEmitter(EMITTER_PROPERTIES, MobEffects.WATER_BREATHING, Const.EffectAmplifier.V, true, true));

    public static final RegistryObject<Item> POISON_NULLIFIER = ITEMS.register("poison_nullifier", () -> new EffectNullifier(NULLIFIER_PROPERTIES, MobEffects.POISON, true, true));
    public static final RegistryObject<Item> WITHER_NULLIFIER = ITEMS.register("wither_nullifier", () -> new EffectNullifier(NULLIFIER_PROPERTIES, MobEffects.WITHER, true, true));
