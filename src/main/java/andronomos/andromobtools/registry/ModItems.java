...
import andronomos.andromobtools.item.*;
...
public class ModItems {
    public static final Item.Properties BASE_PROPERTIES = new Item.Properties().tab(AndroMobTools.ANDROMOBTOOLS_TAB);

    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, AndroMobTools.MOD_ID);
