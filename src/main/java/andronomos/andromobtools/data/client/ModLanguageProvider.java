package andronomos.andromobtools.data.client;
...
import static andronomos.andromobtools.AndroMobTools.TAB_NAME;
import static andronomos.andromobtools.block.MobClonerBlock.SCREEN_MOB_CLONER;
import static andronomos.andromobtools.block.LootAttractorBlock.SCREEN_LOOT_ATTRACTOR;
import static andronomos.andromobtools.block.LootIncineratorBlock.SCREEN_LOOT_INCINERATOR;
import static andronomos.andromobtools.block.pad.MobKillingPadBlock.SCREEN_MOB_KILLING_PAD;
import static andronomos.andromobtools.item.MobStorageCellItem.*;

public class ModLanguageProvider extends LanguageProvider {

	public ModLanguageProvider(DataGenerator gen, String locale) {
		super(gen, AndroMobTools.MOD_ID, locale);
	}
